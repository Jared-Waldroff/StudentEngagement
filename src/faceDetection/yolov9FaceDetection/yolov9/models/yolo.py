...
from src.faceDetection.yolov9FaceDetection.yolov9.models.common import *
from src.faceDetection.yolov9FaceDetection.yolov9.models.experimental import *
from src.faceDetection.yolov9FaceDetection.yolov9.utils.general import LOGGER, check_version, check_yaml, make_divisible, print_args
from src.faceDetection.yolov9FaceDetection.yolov9.utils.plots import feature_visualization
from src.faceDetection.yolov9FaceDetection.yolov9.utils.torch_utils import (fuse_conv_and_bn, initialize_weights, model_info, profile, scale_img, select_device,
                               time_sync)
from src.faceDetection.yolov9FaceDetection.yolov9.utils.tal.anchor_generator import make_anchors, dist2bbox
...
class Detect(nn.Module):
    # YOLO Detect head for detection headPoseDetection
...
class Segment(Detect):
    # YOLO Segment head for segmentation headPoseDetection
...
class Panoptic(Detect):
    # YOLO Panoptic head for panoptic segmentation headPoseDetection
...
class ClassificationModel(BaseModel):
    ...
    def _from_detection_model(self, model, nc=1000, cutoff=10):
        ...
        c.i, c.f, c.type = m.i, m.f, 'headPoseDetection.common.Classify'  # index, from, type
...
if __name__ == '__main__':
    ...
    elif opt.test:  # test all headPoseDetection
        for cfg in Path(ROOT / 'headPoseDetection').rglob('yolo*.yaml'):
            try:
                _ = Model(cfg)
