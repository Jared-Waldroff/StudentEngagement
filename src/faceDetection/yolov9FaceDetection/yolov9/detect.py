...
ROOT = FILE.parents[4]  # Root directory of the project
...
from utils.general import (LOGGER, Profile, check_file, check_img_size, check_imshow, check_requirements, increment_path, non_max_suppression, print_args, scale_boxes, strip_optimizer)
...
def run(
    ...
    model_path = '../../../headPoseDetection/deepHeadPoseLiteMaster/model/shuff_epoch_120.pkl'  # Adjust path
