"""
A simple script to extract the HOG features from DAiSEE_EngagementTraining. This scripts assumes that user has already extracted out the frames from videos
