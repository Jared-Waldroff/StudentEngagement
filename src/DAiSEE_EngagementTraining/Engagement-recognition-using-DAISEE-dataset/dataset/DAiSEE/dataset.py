...
def load_daisee_datasets(batch_size=4, num_workers=0):
    # Define paths
    train_labels_file = '/src/DAiSEE_EngagementTraining-engagement/DAiSEE_EngagementTraining/Labels/TrainLabels.csv'
    train_data_dir = '/src/DAiSEE_EngagementTraining-engagement/DAiSEE_EngagementTraining/DataSet/Train'

    val_labels_file = '/src/DAiSEE_EngagementTraining-engagement/DAiSEE_EngagementTraining/Labels/ValidationLabels.csv'
    val_data_dir = '/src/DAiSEE_EngagementTraining-engagement/DAiSEE_EngagementTraining/DataSet/Validation'

    test_labels_file = '/src/DAiSEE_EngagementTraining-engagement/DAiSEE_EngagementTraining/Labels/TestLabels.csv'
    test_data_dir = '/src/DAiSEE_EngagementTraining-engagement/DAiSEE_EngagementTraining/DataSet/Test'
