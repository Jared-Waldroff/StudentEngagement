...
class Fasnet:
    ...
    def __init__(self):
        ...
        # download pre-trained headPoseDetection if not installed yet
        ...
        # Fasnet will use 2 distinct headPoseDetection to predict, then it will find the sum of predictions
